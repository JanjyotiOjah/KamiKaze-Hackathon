        ...
        <div className="flex-1 flex flex-col justify-center items-center p-10 bg-white">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold mt-6 mb-2">Student Login</h2>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Are you a teacher?{" "}
                  <Link to="/teacher-login" className="text-brand-600 hover:text-brand-800 transition-colors">
                    Teacher Login
                  </Link>
                </p>
              </div>
        ...
        <div className="hidden lg:block lg:w-1/2 relative bg-brand-50">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center p-12">
            <div className="glass p-8 rounded-xl max-w-md">
              <h3 className="text-xl font-semibold mb-4 text-gray-800">Student Learning Platform</h3>
              <p className="text-gray-700 mb-4">
                "LearnSmart helps me track my progress across subjects and get instant help when I'm stuck. The AI-powered assessments really test my understanding, not just memorization."
              </p>
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-800">Aditya Sharma</p>
                  <p className="text-sm text-gray-600">Class 9 Student</p>
                </div>
              </div>
            </div>
          </div>
